               ...
               <div class="layout_wrapper">
                  ...
                  <div class="layout_content">
                     <div class="feed">
                        ...
                        <div id="tweet-content-placeholder"></div>
                                   ...
                                   <div class="joke">
                                      <div class="joke_wrapper">
                                         <div class="joke_block joke_block--header">
                                            <span class="joke_element joke_element--author-name">{{author_name}}</span>
                                            <span class="joke_element joke_element--author-username">{{email}}</span>
          ...
          $.ajax({
              ...
              success: function(response){
                  if(response){
                      ...
                      $("#tweet-content-placeholder").append(tweet_template(tweet_data));
                  }
              },
              contentType: "application/json"
          });
